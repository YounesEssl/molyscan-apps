          ...
          <Card style={styles.section}>
            ...
            <View style={styles.statsRow}>
              <View style={styles.statItem}>
                <Text variant="heading" color={COLORS.primary}>{MOCK_SCANS.length}</Text>
                <Text variant="caption" color={COLORS.textMuted}>Scans</Text>
              </View>
              <View style={styles.statItem}>
                <Text variant="heading" color={COLORS.success}>{MOCK_SCANS.filter((s) => s.status === 'matched').length}</Text>
                <Text variant="caption" color={COLORS.textMuted}>Matchs</Text>
              </View>
              <View style={styles.statItem}>
                <Text variant="heading" color={COLORS.accent}>{Math.round((MOCK_SCANS.filter((s) => s.status === 'matched').length / MOCK_SCANS.length) * 100)}%</Text>
