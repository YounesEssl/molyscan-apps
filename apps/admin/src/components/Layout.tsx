...
import { UserCheck, Users, Tag, Link2, LogOut } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-paper">
      <aside className="sticky top-0 flex h-screen w-72 flex-col border-r border-ink-4 bg-paper-2">
        ...
        <div className="border-t border-ink-4 p-4">
          ...
          <button
            onClick={logout}
            className="mt-1 flex w-full items-center gap-2.5 rounded-2xl px-4 py-2.5 text-sm font-medium text-ink-2 transition-colors hover:bg-black/[0.03] hover:text-ink"
          >
